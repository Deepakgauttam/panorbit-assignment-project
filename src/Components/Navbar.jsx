          ...
          <div className="relative">
            ...
            {open ? (
              <div
                ...
                className="absolute top-10 right-0 bg-white rounded-3xl shadow-md p-4 w-[19rem] z-10"
              >
                {/* User information */}
                <div className="block">
                  <img
                ...
                {users.slice(0, 3).map((user) => (
                  <li key={user.id} className=" mt-4 list-none ">
                    <div className="flex items-center pl-[60px] pb-[5px] bg-white">
                      <img
                ...
                <div className="block mt-4 ">
                  <button
                    ...
                    className="bg-blue-500 text-white font-semibold text-sx py-1 px-4 rounded-[2rem]"
                  >
                    Sign out
                  </button>
                </div>
